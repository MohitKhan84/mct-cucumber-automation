...
public class MasterPage {
	...
	public WebElement getWebElementBy(String locators) {
		...
		if (locators.contains("{name")) {
			tempWebElement = driver.findElement(By.className(locators.split(":")[1]));	
	...
	public void typeText(WebElement targetWebElement, String texttoWrite) {
		
		targetWebElement.sendKeys(texttoWrite);
	}
